...
import com.sds.intern.data.DetailMode;
import com.sds.intern.data.LocalDataSource;
import com.sds.intern.data.MediaBucket;
import com.sds.intern.data.MediaBucketList;
import com.sds.intern.data.MediaFeed;
import com.sds.intern.data.MediaItem;
import com.sds.intern.data.MediaSet;
import com.sds.intern.data.Util;
import com.sds.intern.music3d.PopupMenu.Option;
    ...
    private void buildMoreOptions() {
        ...
        if (numBuckets == 1) {
            ...
            if (bucket.mediaItems == null || bucket.mediaItems.size() == 0) {
                ...
                mediaType = (Integer) items.get(0).getMediaType();
                if (numItems == 1) {
                    singleItem = true;
                } else {
                    for (int i = 1; i < numItems; ++i) {
                        if ((Integer)items.get(0).getMediaType() != mediaType) {
                            albumMode = true;
                            break;
                        }
                    }
            ...
            for (int j = 0; j < numBuckets; ++j) {
                ...
                for (int i = 0; i < numItems; ++i) {
                    ...
                    if (mimeType == null) {
                        ...
                        mediaType = (Integer) item.getMediaType();
                    ...
                    if (mediaType != (Integer)item.getMediaType()) {
