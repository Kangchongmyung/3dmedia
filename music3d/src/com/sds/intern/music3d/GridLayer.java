...
import com.sds.intern.data.DataSource;
import com.sds.intern.data.LocationMediaFilter;
import com.sds.intern.data.MediaBucket;
import com.sds.intern.data.MediaBucketList;
import com.sds.intern.data.MediaFeed;
import com.sds.intern.data.MediaFeed.Listener;
...
public final class GridLayer extends RootLayer implements Listener, TimeBar.Listener {
            ...
            if (metadata) {
                ...
                if (slot.hasValidLocation()) {
                    ...
                    if (set.mReverseGeocodedLocation != null) {
                        enableLocationFiltering((String) set.mReverseGeocodedLocation);
                    }
